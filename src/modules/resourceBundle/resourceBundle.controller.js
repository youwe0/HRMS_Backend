...
import { Blood_group, Gender, Employee_type, HolidayBasedOnType } from "../../shared/config/generalConfig.js";
...
export const getResourceBundle = asyncHandler(async (_req, res) => {
  const data = { Blood_group, Gender, Employee_type, HolidayBasedOnType };
