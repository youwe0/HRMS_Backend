...
router.get('/', validate(userValidators.userListQuerySchema, 'query'), userController.getUsers);
router.post('/', validate(userValidators.createUserSchema), userController.createUser);
router.get('/:id', validate(objectIdParamSchema, 'params'), userController.getUser);
router.patch(
  '/:id',
