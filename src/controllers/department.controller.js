...
export const createDepartment = asyncHandler(async (req, res) => {
  ...
  sendSuccess(res, HTTP_STATUS.CREATED, 'Department created successfully', { department });
});
...
export const getDepartment = asyncHandler(async (req, res) => {
  ...
  sendSuccess(res, HTTP_STATUS.OK, 'Department fetched successfully', { department });
});

export const updateDepartment = asyncHandler(async (req, res) => {
  const department = await departmentService.updateDepartment(req.params.id, req.body);
  sendSuccess(res, HTTP_STATUS.OK, 'Department updated successfully', { department });
});
